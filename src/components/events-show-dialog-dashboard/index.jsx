...
const EventsShowDialogDashboard = () => {
  const {
    queryObject: { notification_event: event },
    deleteParam,
  } = useQueryParams();
  const onClose = () => deleteParam("notification_event");
...
export default EventsShowDialogDashboard;
